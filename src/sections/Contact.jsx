...
function Contact() {
  ...
  return (
    <motion.div 
      className="min-h-screen bg-[#010103] text-white flex flex-col items-center py-16 px-4"
      initial="hidden"
      animate="visible"
      ...
      <div className="w-full max-w-7xl flex flex-col lg:flex-row lg:justify-between lg:gap-16">
        ...
        >
          ...
          <form onSubmit={onSubmit}>
            ...
            <motion.button
              type="submit"
              className="w-full py-3 bg-blue-600 rounded-md text-white font-semibold"
