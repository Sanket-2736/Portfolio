        ...
        <div className="space-y-16">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between relative">
            <div className="w-full md:w-1/2 text-right pr-8">
              <div className="bg-blue-700 p-6 rounded-lg shadow-md transition-transform transform hover:scale-105 hover:shadow-lg">
            ...
            <div className="absolute bg-blue-700 w-8 h-8 rounded-full top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2"></div>
          </div>
          ...
          <div className="flex flex-col md:flex-row-reverse items-center justify-between relative">
            <div className="w-full md:w-1/2 text-left pl-8">
              <div className="bg-green-700 p-6 rounded-lg shadow-md transition-transform transform hover:scale-105 hover:shadow-lg">
            ...
            <div className="absolute bg-green-700 w-8 h-8 rounded-full top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2"></div>
          </div>

          {/* Current Education Box */}
          <div className="flex flex-col md:flex-row items-center justify-between relative">
            <div className="w-full md:w-1/2 text-right pr-8">
              <div className="bg-indigo-700 p-6 rounded-lg shadow-md transition-transform transform hover:scale-105 hover:shadow-lg">
            ...
            <div className="absolute bg-indigo-700 w-8 h-8 rounded-full top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2"></div>
          </div>

          {/* Box 3 - Flipped to right */}
          <div className="flex flex-col md:flex-row-reverse items-center justify-between relative">
            <div className="w-full md:w-1/2 text-left pl-8">
              <div className="bg-yellow-700 p-6 rounded-lg shadow-md transition-transform transform hover:scale-105 hover:shadow-lg">
            ...
            <div className="absolute bg-yellow-700 w-8 h-8 rounded-full top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2"></div>
          </div>
          ...
          {/* Box 4 */}
            ...
            <div className="absolute bg-purple-700 w-8 h-8 rounded-full top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/4"></div>
            </div>
            ...
            <div className="absolute bg-red-700 w-8 h-8 rounded-full top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/4"></div>
            </div>
